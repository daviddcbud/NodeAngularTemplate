...
function setupRequestResponse(req,res) {
	...
	res.status=function(s){
		return res; //return itself for chaining
      };
}
...
describe('Controller Tests', function() {
  ...
  it('should return items', function(){
     var Model={};
     var items=[];
     //setup mock model to avoid real mongodb connections
	...
	var spy1=sinon.spy(res,"send");
     ...
     //test that the get method sends the items
  ...
  it('should return 500', function() {
 	...
 	var Model = {};
 	//setup the mock model that returns an error
